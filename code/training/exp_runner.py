...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gamma", type=float, default=1.0, help="inverse gamma correction coefficient"
    )

    parser.add_argument(
        "--geometry", type=str, default="", help="path to pretrained geometry"
    )
    parser.add_argument(
        "--freeze_geometry", default=False, action="store_true", help=""
    )
    ...
    parser.add_argument("--freeze_idr", default=False, action="store_true", help="")
